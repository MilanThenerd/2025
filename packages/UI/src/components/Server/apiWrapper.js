...
//queryDocuments: /databases/:databaseID/collections/:collection/documents/query (POST) -> .emit("addCommand", "create", data)
  async queryDocuments(databaseID, collectionName, filter) 
  {
      return this.request(`/collections/${collectionName}/documents/query`, 'POST', filter);
  }
...
//   {
//       return this.request(`/collections/${collectionName}/indexes`);
//   }
